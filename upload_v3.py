...
# Proper ChatTTS script with correct API
...
start = time.time()
wavs = chat.infer(text, skip_refine=True)
...
with t.open("/root/egg_video/gen_chattts_v3.py", "w") as f:
    f.write(script)

t.close()
ssh.close()
print("Uploaded v3 script!")
